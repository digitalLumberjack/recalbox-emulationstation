...
void initMetadata() {
  ...
  gameMDD.push_back(MetaDataDecl("video",	MD_PATH,		"", 			false,		_("Video"),			_("enter path to thumbnail")));
  gameMDD.push_back(MetaDataDecl("marquee",	MD_PATH,		"", 			false,		_("Marquee"),			_("enter path to image")));
